...
<link rel="shortcut icon"
	href="<%=request.getContextPath()%>/img/common/logo.png"
	type="image/x-icon">
<title>GSP查询结果页|仁爱药品管理系统</title>
<!-- 获取并控制屏幕信息(响应式) -->
<meta
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/framework/AdminLTE/dist/css/skins/skin-blue.min.css">
<style type="text/css">
.treeview-menu>li>a {
	text-indent: 2em;
}
	...
	<div class="wrapper" id="mybtn1">
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a
								...
								target="iframe_content">销售记录创建</a></li>
							<li><a
								href="<%=request.getContextPath()%>/search_MedicineSaleRecordAction">销售记录查询</a></li>
							<%-- 
                            	<%=request.getContextPath()%>/MedicineMS/sell/MSaleRecord/search/search_MsaleRecord.jsp
                            --%>
							<li><a
        ...
        <small>Optional description</small>
			...
			<div class="iframeBlock">
				<iframe id="myIFRAME" onload="autoHeight()" scrolling="no" name="iframe_content" src="<%=request.getContextPath()%>/MedicineMS/sell/MSaleRecord/add/add_MSaleRecord.jsp" frameborder="0" seamless>
					<p>您的浏览器不支持使用iframe框架.[Recommend Browsers：Chrome
						Browser|FireFox Browser|QQ Browser|360 Browser]</p>
				</iframe>
			</div>
			<!--|----------------------------------------------------------------------------------------------------------  -->
