...
<body style="background-color: rgba(0, 0, 0, 0);" onload="javascript:reloadBydyHeight();">
 ...
 -->
    <div class="header text-left flex">
        <div class="login-header-img-cont" style=""><img src="../../../img/common/logo.png" class="img-responsive login-header-img" style=""></div>
        <div class="login-header-title-cont" style=""><a href="<%=request.getContextPath()%>">仁爱药品管理系统</a></div>
    </div>
    ...
    <footer class="footer">
        <div>
           <a href="/MedicineMS/MedicineMS/SYS/view/aboutUs.html" target="_blank">关于我们</a> &nbsp;|&nbsp;
